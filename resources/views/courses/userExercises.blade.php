    ...
    <div id="app">
        ...
        <div id="accordion" class="">
            @php
                $x = 0;
            @endphp
            @foreach($course->user()->get() as $user)
                <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @foreach($course->lessons()->orderBy('nr', 'asc')->get() as $lesson)
                                <div class="PPS-content-wrapper">
                                    <div class="PPS-content-heading"><h4>Nodarbība: {{$lesson->name}}</h4></div>
                                        ...
                                        <div class="row p-1">
                                            ...
                                            <div class="col-6">
                                                ...
                                                @if($solution != null || $submission != null)
                                                    ...
                                                    @endphp
                                                @else
                                                    <div style="background-color: red; color: white;" class="row justify-content-around text-center PPS-content-wrapper rounded">Uzdevums nav iesūtīts</div>
                                                @endif
