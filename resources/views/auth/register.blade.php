    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="PPS-content-wrapper">
                <div class="PPS-content-header p-2">{{ __('Register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('Lietotājvārds') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Epasta adrese') }}</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn PPS-info-button">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
